...
type OptimizationJobLogRepository interface {
	...
	GetByJobID(ctx context.Context, jobID uuid.UUID) (*model.OptimizationJobLog, error)
}
...
func (r *optimizationJobLogRepository) GetByJobID(ctx context.Context, jobID uuid.UUID) (*model.OptimizationJobLog, error) {
